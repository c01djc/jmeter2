...
public class KerningOptimizer {
    ...
    public void configureKerning(JComponent component, int documentLength) {
        ...
        if (kerning != desiredKerning) {
            ...
            Font font = component.getFont();
            // Prefer current LAF/zoom size so kerning tweaks do not freeze a pre-zoom font size
            Font lafFont = UIManager.getFont("TextArea.font");
            if (lafFont != null) {
                font = font.deriveFont(lafFont.getSize2D());
            }
