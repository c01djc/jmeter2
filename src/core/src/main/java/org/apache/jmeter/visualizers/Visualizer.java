...
public interface Visualizer {
    ...
    /**
     * Whether {@link #add(SampleResult)} is safe to call from sampler threads
     * without marshalling to the EDT. Queue-based visualizers return {@code true}.
     *
     * @return true if off-EDT add is safe
     */
    default boolean supportsConcurrentAdd() {
        return false;
    }
}
