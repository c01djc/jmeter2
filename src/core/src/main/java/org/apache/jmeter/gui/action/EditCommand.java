...
public class EditCommand extends AbstractAction {
    ...
    public void doAction(ActionEvent e) {
        ...
        if (currentGui instanceof JComponent) {
            JComponent panel = (JComponent) currentGui;
            mainFrame.setMainPanel(panel);
            // Second layout pass after EDT settles — fixes clipped/incomplete panels
            // that appear after long editing sessions or HiDPI/LAF churn.
        ...
        mainFrame.setEditMenu(guiPackage.getTreeListener().getCurrentNode().createPopupMenu());
        TextComponentUI.INSTANCE.resetUndoHistory();
        mainFrame.setFileLoadEnabled(true);
        mainFrame.setFileSaveEnabled(true);
    }
