...
public abstract class AbstractVisualizer
    ...
    /**
     * Most concrete visualizers buffer samples and refresh on a Timer, so sampler
     * threads can call {@link #add} without hopping to the EDT every sample.
     */
    @Override
    public boolean supportsConcurrentAdd() {
        return true;
    }
