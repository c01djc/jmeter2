...
public class AboutCommand extends AbstractAction {
    ...
    private static JDialog initDialog(JFrame mainFrame) {
        ...
        about = new EscapeDialog(mainFrame, "About " + org.apache.jmeter.JMeter2Branding.APP_NAME, false);
        ...
        JLabel version = new JLabel(org.apache.jmeter.JMeter2Branding.APP_NAME + " Version " + JMeterUtils.getJMeterVersion()
                + " (based on Apache JMeter " + org.apache.jmeter.JMeter2Branding.UPSTREAM_BASE_VERSION + ")",
                SwingConstants.CENTER);
        JLabel author = new JLabel("<html>Author: <a href=\""
                + org.apache.jmeter.JMeter2Branding.AUTHOR_GITHUB_URL + "\">"
                + org.apache.jmeter.JMeter2Branding.AUTHOR_NAME + "</a></html>", SwingConstants.CENTER);
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() > 0) {
                    ActionRouter.getInstance().doActionNow(
                            new ActionEvent(e.getSource(), e.getID(), ActionNames.LINK_AUTHOR_GITHUB));
                }
            }
        });
