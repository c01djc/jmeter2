...
function getElapsedTimeLabel(granularity) {
    var g = formatDuration(granularity);
    if (window.JM2I18n) {
        return JM2I18n.t("elapsed_time", null, { g: g });
    }
    return "Elapsed Time (granularity: " + g + ")";
}
...
function getConnectTimeLabel(granularity) {
    var g = formatDuration(granularity);
    if (window.JM2I18n) {
        return JM2I18n.t("connect_time_g", null, { g: g });
    }
    return "Connect Time (granularity: " + g + ")";
}
